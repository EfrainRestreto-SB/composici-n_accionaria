...
Versión CLEAN: Sin sistema de auto-reparación - Para usar con Python Portable
"""
...
# Importaciones necesarias (ya instaladas en Python Portable)
import pandas as pd
...
def consolidate_participations(excel_file):
    ...
    """
    try:
        print("=== INICIANDO CONSOLIDACION INTELIGENTE v6-CLEAN ===")
...
def main():
    """Función principal"""
    if len(sys.argv) < 2:
        print("[ERROR] Uso: python fix_dra_blue_clean.py <archivo_excel>")
        return False
